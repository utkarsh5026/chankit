...
export default defineConfig({
  title: "chankit",
  description:
    "Elegant, type-safe channel operations for Go with functional programming patterns",
  base: "/chankit/",
  ...
  head: [
    ...
    [
      ...
      {
        name: "og:title",
        content: "chankit - Elegant channel operations for Go",
      },
    ],
    [
      "meta",
      {
        name: "og:description",
        content:
          "Type-safe channel operations with functional programming patterns",
      },
    ],
  ],
      ...
      "/examples/": [
        {
          ...
          items: [
            ...
            {
              text: "Search Results Processing",
              link: "/examples/search-results",
            },
            { text: "Rate Limiting", link: "/examples/rate-limiting" },
            {
              text: "Data Transformation Stream",
